...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:usbinfo@usbaburau.com?subject=${encodeURIComponent(form.subject)}&body=${body}`;
    setSent(true);
  };
    ...
    <main className="contact-page">
      ...
      <section className="quick-actions">
        <AnimatedSection className="qa-inner">
          <a href="tel:+918242420949" className="qa-card">
            <FiPhone size={28} color="var(--orange)" />
            <div>
              <span>Call Us</span>
              <strong>+91 824 2420949</strong>
            </div>
          </a>
